...
function handleSignup(e) {
  ...
  if (!phone) {
    ...
    showError('phoneInput', 'phoneError', 'Enter a valid Nigerian number e.g. 08012345678');
    isValid = false;
  } else {
  ...
  // Simulate delay — later this hits the backend
  setTimeout(() => {
    alert('Account created successfully! Welcome to VerifiedNG.');
...
document.addEventListener('DOMContentLoaded', function () {
  const fields = ['firstName', 'lastName', 'emailInput', 'phoneInput', 'stateInput', 'addressInput', 'passwordInput'];
  fields.forEach(id => {
