// ─── SHARED PROVIDERS DATA ───
// This is your central "database" for all providers.
// Every page that needs provider data loads this file first.
...
const providers = [
  {
    ...
    experience: [
      ...
      {
        icon: "🎂",
        title: "Pastry Chef — Kwara Cuisine",
        desc: "Specialised in baking and pastry work for events, weddings and corporate clients.",
    ...
    reviews: [
      {
        ...
        stars: "★★★★★",
        text: "She catered my daughter's wedding and every single guest was raving about the food. The jollof rice alone was worth every naira. Professional, punctual and truly passionate about her craft.",
      ...
      },
      {
        ...
        stars: "★★★★★",
        text: "Ordered her small chops for our company event. 200 guests and not a single complaint about the food. She delivered on time and everything was fresh and delicious.",
        tag: "Corporate Event",
      },
      {
        avatar: "👩🏾",
        ...
        stars: "★★★★★",
        text: "Best caterer in Kwara, full stop. Her chin-chin and puff puff are absolutely out of this world. I order from her every month for family gatherings.",
        tag: "Baking",
      },
    ],
    gallery: ["🍲", "🎂", "🍗", "🥘", "🍱", "🎉"],
    ...
    reviews: [
      {
        ...
        stars: "★★★★★",
        text: "Miss Gift changed my life literally. I was confused about my career path and after just 2 sessions with her I had complete clarity. She listens without judgment and gives practical advice that actually works.",
      ...
      },
      {
        ...
        stars: "★★★★★",
        text: "Hired her to counsel my son before JAMB and university choice. He went from a D student to getting admitted into his first choice school. She has a gift for bringing out the best in young people.",
      ...
      },
      {
        ...
        stars: "★★★★★",
        text: "Online session was excellent. She helped me navigate a very difficult career transition and I'm now 6 months into my dream job. Worth every kobo.",
        tag: "Life Coaching",
      },
    ],
    gallery: ["📚", "🧠", "🎯", "💡", "🌟", "✅"],
...

  {
    ...
    experience: [
      ...
      {
        icon: "🔧",
        title: "Lead Mechanic — Toyota Nigeria Service Centre",
        desc: "Senior mechanic handling diagnostics, servicing and complex repairs for Toyota vehicles.",
    ...
    reviews: [
      {
        ...
        stars: "★★★★★",
        text: "Fixed my Honda Accord in 2 hours. Honest pricing and no surprises. He told me exactly what was wrong and showed me the problem before fixing it. That kind of transparency is rare.",
        tag: "Engine Repair",
      },
      {
        avatar: "👩🏾",
        ...
        stars: "★★★★★",
        text: "My car broke down on Third Mainland Bridge and he came to me within 30 minutes. Fixed it on the spot. Absolute legend. Saved my whole day.",
      ...
      },
      {
        ...
        stars: "★★★★★",
        text: "Been using Mr. Fatai for 8 years now. He has never once overcharged me or invented a problem that wasn't there. In Lagos that is extremely rare. My family's mechanic for life.",
        tag: "Full Servicing",
      },
    ],
    gallery: ["🚗", "🔧", "⚙️", "🛻", "💿", "🔩"],
    ...
    reviews: [
      {
        ...
        stars: "★★★★★",
        text: "She handled our restaurant's Instagram for 2 months and our followers grew from 400 to 4,200. The content quality is stunning and she captures the essence of our brand perfectly.",
      ...
      },
      {
        ...
        stars: "★★★★★",
        text: "Product photography was incredible. My WhatsApp catalogue now looks like a proper brand. Customers comment on the quality of my photos all the time now.",
      ...
      },
      {
        ...
        stars: "★★★★★",
        text: "She created a TikTok video for my food business that got 45,000 views. I had to close orders for 2 weeks because I was overwhelmed. Best investment I ever made.",
        tag: "Video Content",
      },
    ],
    gallery: ["📸", "🎥", "📱", "✨", "🎨", "📊"],
    ...
    reviews: [
      {
        ...
        stars: "★★★★★",
        text: "They deep cleaned my 3-bedroom apartment before I moved in. The place was sparkling. They got to corners and surfaces I didn't even think to mention. Very thorough team.",
        tag: "Deep Cleaning",
      },
      {
        avatar: "👨🏾",
        ...
        stars: "★★★★★",
        text: "Post-construction cleaning for a 6-unit building. They handled everything professionally, removed all construction debris and dust. Site was ready for handover the same day.",
      ...
      },
      {
        ...
        stars: "★★★★★",
        text: "We use them every week for our office. Always punctual, always thorough and the team is professional and respectful. Great value for the quality of service.",
        tag: "Office Cleaning",
      },
    ],
    gallery: ["🧹", "🏠", "🏢", "✨", "🧴", "💧"],
...

  {
    ...
    reviews: [
      ...
      },
      {
        ...
        stars: "★★★★★",
        text: "She integrated a full payment system into our React app seamlessly. Responds fast, explains everything in plain English and her support after deployment is excellent.",
        tag: "API Integration",
      },
    ],
    gallery: ["💻", "🖥️", "📱", "⚙️", "🔐", "🚀"],
...

  {
    ...
    experience: [
      {
        icon: "🔧",
        title: "Professional Plumber — Self Employed",
        desc: "Running independent plumbing service across Kaduna State for residential and commercial clients.",
        date: "2019 — Present · 5 years",
      },
      {
        icon: "🏗️",
    ...
    reviews: [
      ...
      },
      {
        ...
        stars: "★★★★★",
        text: "My bathroom had a serious drainage problem for months. He fixed it permanently in one visit. Other plumbers kept patching it. He found the real cause and solved it properly.",
        tag: "Drainage Repair",
      },
    ],
    gallery: ["🔧", "🏠", "💧", "🚿", "🛁", "⚙️"],
